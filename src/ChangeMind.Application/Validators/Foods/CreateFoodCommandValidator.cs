...
public sealed class CreateFoodCommandValidator : AbstractValidator<CreateFoodCommand>
{
    public CreateFoodCommandValidator()
    {
        ...
        When(x => x.Unit == FoodMeasurementUnit.Grams, () =>
        {
            ...
            RuleFor(x => x.CaloriesPerPiece).Null().WithMessage("Grams birimli besinde 'caloriesPerPiece' kullanılmamalıdır.");
        ...
        When(x => x.Unit == FoodMeasurementUnit.Piece, () =>
        {
            ...
            RuleFor(x => x.CaloriesPer100g).Null().WithMessage("Piece birimli besinde 'caloriesPer100g' kullanılmamalıdır.");
